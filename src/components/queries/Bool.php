 ...
 * Bool Query
 *
 * @method \SherlockHolmesnts\queries\Bool minimum_number_should_match() minimum_number_should_match(\int $value) Default: 2
 * @method \Sherlock\cHolmess\queries\Bool boost() boost(\float $value) Default: 1.0
 * @method \Sherlock\comHolmesqueries\Bool disable_coord() disable_coord(\int $value) Default: 1
 */
