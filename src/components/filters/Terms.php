...
/**
 * @method \Holmes\components\filters\Terms field() field(\string $value)
 * @method \Holmes\components\filters\Terms execution() execution(\string $value) Default: "plain"
 * @method \Holmes\components\filters\Terms _cache() _cache(\bool $value) Default: true

 */
class Terms extends \Holmes\components\BaseComponent implements \Holmes\components\FilterInterface
{
