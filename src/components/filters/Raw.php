...
/**
 * @method \Holmes\components\filters\Raw Raw() Raw(\string $json)

 */
class Raw extends \Holmes\components\BaseComponent implements \Holmes\components\FilterInterface
{
    /**
