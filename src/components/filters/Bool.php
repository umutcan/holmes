...
use Holmes\components\FilterInterface;

/**
 * Bool Filter
 * 
 * @method \Holmes\components\filters\Bool _cache() _cache(\bool $value) Default: false
 */
class Bool extends \Holmes\components\BaseComponent implements FilterInterface
{
    /**
