 ...
 *
 * @method \Holmes\components\facets\Query facetname() facetname(\string $value)
 * @method \Holmes\components\facets\Query query() query(\Holmes\components\QueryInterface $value)
